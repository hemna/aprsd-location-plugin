...
def geopy_factory():
    ...
    geocoder = CONF.aprsd_location_plugin.geopy_geocoder
    LOG.info(f"Using geocoder: {geocoder}")
    user_agent = CONF.aprsd_location_plugin.user_agent
    ...
    if geocoder == "Nominatim":
        ...
        return ArcGIS(
            username=CONF.aprsd_location_plugin.arcgis_username,
            password=CONF.aprsd_location_plugin.arcgis_password,
