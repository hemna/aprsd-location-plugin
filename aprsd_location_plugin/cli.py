#!/usr/bin/env python3
"""
CLI tool for aprsd-location-plugin configuration export.
"""
...
def export_config_cmd(format="json"):
    ...
    try:
        from aprsd_location_plugin.conf.opts import export_config
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Export aprsd-location-plugin configuration options"
    )
    parser.add_argument(
        "--format",
        choices=["dict", "json"],
